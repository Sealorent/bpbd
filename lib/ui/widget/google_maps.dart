...
class _GoogleMapsPageState extends State<GoogleMapsPage> {
  ...
  void initState() {
    ...
    BlocProvider.of<GetLocationCubit>(context).getCurrentLocation();
      ...
      children: [
        BlocBuilder<GetLocationCubit, GetLocationState>(
          ...
          if (state is GetLocationSuccess) {
            String url =
                'https://www.google.com/maps/place/@${state.data.latitude},${state.data.longitude},15z';
            return SizedBox(
            ...
            child: TextButton(
              ...
              child: Center(
                child: Text(
                  ...
                  style: defaultStyle.copyWith(fontSize: 10, color: blackColor),
                ),
              ),
            ),
          ),
